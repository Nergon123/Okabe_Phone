...
typedef void * (ZIP_OPEN_CALLBACK)(const char *szFilename, void* ud, int32_t *pFileSize);
...
extern unzFile ZEXPORT unzOpen OF((const char *path, void *ud, uint8_t *pData, uint32_t u32DataSize, ZIPFILE *pzf, ZIP_OPEN_CALLBACK *pfnOpen, ZIP_READ_CALLBACK *pfnRead, ZIP_SEEK_CALLBACK *pfnSeek, ZIP_CLOSE_CALLBACK *pfnClose));
/*

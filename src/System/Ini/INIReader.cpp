...
string INIReader::GetStringUnquoted(const string& section, const string& name,
                                    const string& default_value) const {
    string str = Get(section, name, "");
...
INI_API int64_t INIReader::GetInteger64(const string& section, const string& name,
...
unsigned long INIReader::GetUnsigned(const string& section, const string& name,
...
INI_API uint64_t INIReader::GetUnsigned64(const string& section, const string& name,
...
std::vector<string> INIReader::Sections() const {
    ...
    for (std::map<string, string>::const_iterator it = _values.begin(); it != _values.end();
         ++it) {

 ...
 *
 *  Modifications Copyright AirDeeEx.
 *  - add section counter to browse callback
 */
#ifndef MININI_H
#define MININI_H
...
typedef int (*INI_CALLBACK)(const mTCHAR *Section, const mTCHAR *Key, const mTCHAR *Value, int SectionIndex, void *UserData);

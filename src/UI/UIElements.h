...
bool   button(NString title, int xpos, int ypos, int w, int h, bool selected = false, int *direction = nullptr, bool usable = true, void  (*callback)(void *) = nullptr);
...
NString InputField(NString title, NString content, int ypos, bool onlydraw, bool selected, bool used, int *direction = nullptr, bool onlynumbers = false,bool usable = true, void  (*callback)(void *) = nullptr);
